...
typedef void (*GroupFeedbackHandlerFunction)(AmberGroupFeedbackPtr fbk,
                                             void *user_data);
 ...
 */
AmberStatusCode amberLookupSetLookupFrequencyHz(AmberLookupPtr lookup,
 ...
 */
AmberStatusCode amberLookupEntryListGetName(AmberLookupEntryListPtr lookup_list,
 ...
 */
AmberStatusCode
amberLookupEntryListGetFamily(AmberLookupEntryListPtr lookup_list, size_t index,
                              char *family, size_t *length);
 ...
 */
AmberStatusCode
amberLookupEntryListGetSerialNumber(AmberLookupEntryListPtr lookup_list,
                                    size_t index, char *serialNumber,
                                    size_t *length);
 ...
 */
AmberFeedbackPtr
amberGroupFeedbackGetModuleFeedback(AmberGroupFeedbackPtr feedback,
                                    size_t module_index);
 ...
 */
AmberGroupPtr amberGroupCreateFromFamily(AmberLookupPtr lookup,
                                         const char *family,
                                         int32_t timeout_ms);
 ...
 *
 * @param group The group to send this command to.
 * @param command The AmberGroupCommand object containing information to be sent
 * to the group.
 *
 * @returns AmberStatusSuccess if the command was successfully sent, otherwise a
 * failure code.
 */
AmberStatusCode amberGroupSendCommand(AmberGroupPtr group,
 ...
 */
AmberStatusCode amberGroupSetCommandLifetime(AmberGroupPtr group,
                                             int32_t lifetime_ms);
 ...
 * @returns AmberStatusSuccess on success，AmberStatusFailure on failed.
 */
AmberStatusCode amberGroupSetFeedbackFrequencyHz(AmberGroupPtr group,
                                                 const float frequency);
...
AmberStatusCode amberGroupSendFeedbackRequest(
    AmberGroupPtr group, AmberFeedbackCode feedbackCode = AmberFeedbackAll);
 ...
 * @returns AmberStatusSuccess on success，AmberStatusFailure on failed.
 */
AmberStatusCode amberGroupGetNextFeedback(AmberGroupPtr group,
                                          AmberGroupFeedbackPtr feedback,
                                          int32_t timeout_ms);

// TODO:
AmberStatusCode amberGroupRegisterFeedbackHandler(
    AmberGroupPtr group, GroupFeedbackHandlerFunction handler, void *user_data);
 ...
 */
AmberCommandPtr amberGroupCommandGetModuleCommand(AmberGroupCommandPtr command,
                                                  size_t module_index);
...
AmberStatusCode amberSetLogLevel(const char *mode);
 ...
 *
 * \return AmberStatusSuccess on success, otherwise AmberStatusInvalidArgument
 * if a parameter is NULL.
 */
AmberStatusCode amberGetLibraryVersion(int32_t *major, int32_t *minor,
                                       int32_t *revision);
