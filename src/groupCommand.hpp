...
public:
    ...
    /**
     * @brief Convenience function for setting TrapezoidalMove commands from vectors.
     *
     * Note that if the vector is not the correct link, no action is taken.
     */
    ...
    /**
     * @brief Convenience function for setting velocity ramp commands from vectors.
     *
     * Note that if the vector is not the correct link, no action is taken.
     */
     ...
     * Note that if the vector is not the correct link, no action is taken.
     */
    void setMontionCtrlConfig(const std::vector<MotionControllerConfig *> &config);
